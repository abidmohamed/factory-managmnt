...
urlpatterns = [
    ...
    path('create_buyorder/<str:pk>', views.create_buyorder, name='create_buyorder'),
    ...
    path('buyorderorder_list_by_supplier/<str:pk>', views.buyorderorder_list_by_supplier,
         name='buyorderorder_list_by_supplier'),
